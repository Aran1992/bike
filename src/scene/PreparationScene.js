...
export default class PreparationScene extends Scene {
    ...
    onShow(mode) {
        ...
        this.ui.gameLevelTitleLabel.visible = false;
        ...
        if (this.mode === "Map") {
            ...
            this.ui.gameLevelTitleLabel.visible = true;
            const mainScene = App.getScene("MainScene");
            this.ui.gameLevelTitleLabel.text = App.getText(Config.gameLevelMode.mapList[mainScene.gameLevel].dsc);
