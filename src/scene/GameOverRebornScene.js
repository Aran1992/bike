...
export default class GameOverRebornScene extends Scene {
    onCreate() {
    ...
    onClickLeaveButton() {
        App.hideScene("GameOverRebornScene");
        App.showScene("GameOverScene", {
            gameScene: this.args.gameScene
        });
    }
...
GameOverRebornScene.sceneFilePath = "myLaya/laya/pages/View/GameOverRebornScene.scene.json";
